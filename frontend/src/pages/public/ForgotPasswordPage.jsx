      ...
      <div className="hidden lg:flex lg:w-1/2 bg-charcoal text-cream flex-col justify-between p-10">
        ...
        <div>
          ...
          <p className="mt-3 text-cream/70 leading-relaxed">
            We'll send a 6-digit code to your email so you can reset your password quickly and securely.
          </p>
        </div>
          ...
          {!sent ? (
            <>
              <div className="mb-6">
                ...
                <h1 className="font-fraunces text-2xl font-bold text-charcoal">Reset your password</h1>
            ...
            <div className="text-center">
              ...
              <h2 className="font-fraunces text-2xl font-bold text-charcoal">Code sent!</h2>
              <p className="mt-2 text-sm text-charcoal/60">
                We've sent a 6-digit reset code to <strong className="text-charcoal">{email}</strong>.
                <br />
