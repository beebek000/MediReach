    ...
    <div className="space-y-8 page-enter">
      <div className="rounded-2xl bg-gradient-to-r from-primary/20 to-primary/5 border border-primary/20 p-6">
        ...
        <p className="text-charcoal/70 mt-1">
          Here's your medicine and order overview.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-charcoal/10 bg-white overflow-hidden">
        <div className="flex items-center justify-between px-4 py-3 border-b border-charcoal/10">
          <h3 className="font-fraunces font-semibold text-charcoal">
            Recent Orders
          </h3>
          <Link
            to="/customer/orders"
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-charcoal/5 text-left">
                <th className="px-4 py-3 font-medium text-charcoal">
                  Order ID
                </th>
            ...
            <tbody>
              {recent.map((o) => (
                <tr
                  key={o.id}
                  className="border-t border-charcoal/5 hover:bg-charcoal/[0.02]"
                >
        ...
        {recent.length === 0 && (
          <div className="p-8 text-center text-charcoal/50">
            No orders yet.{" "}
            <Link to="/medicines" className="text-primary">
              Browse medicines
            </Link>
            .
          </div>
      ...
      <div className="rounded-xl border border-charcoal/10 bg-white p-6">
        <h3 className="font-fraunces font-semibold text-charcoal mb-4">
          Quick Actions
        </h3>
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            ...
            className="rounded-lg border border-charcoal/20 px-4 py-2 text-sm font-medium hover:bg-charcoal/5 transition-colors"
          >
            Upload Prescription
          </Link>
          <Link
